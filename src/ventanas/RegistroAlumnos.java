...
public class RegistroAlumnos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhos:3306t/bd_ins", "root", "root");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/bd_ins", "root", "root");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       Document documento = new Document();
        ...
        try {
            ...
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "Reporte_Alumnos.pdf"));
            documento.open();
            ...
            try {
                Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_ins", "root", "root");
